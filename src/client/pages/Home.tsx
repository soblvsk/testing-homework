    ...
    <div className={bem()}>
      ...
      <div className='row'>
        <div className='col bg-secondary text-white py-4 bg-opacity-75'>
          ...
          <p className='lead'>Culpa perspiciatis corporis facilis fugit similique</p>
          <p className='lead'>Cum aut ut eveniet rem cupiditate natus veritatis quia</p>
        </div>
      </div>
      ...
      <div className='row mb-4'>
        <div className='col-12py-3'>
          <p>
            ...
            Explicabo itaque est optio neque rerum provident enim qui sed. Corrupti commodi voluptatem vero
            soluta hic.
          </p>
          <p>
            Modi corporis consectetur aliquid sit cum tenetur enim. Sed voluptatum quis voluptates laudantium
            incidunt laudantium. Illo non quos eos vel ipsa. Explicabo itaque est optio neque rerum provident
